...
int CClientServerTcp::test2(){
    ...
    c_flow = m_c_ctx.m_ft.alloc_flow(&m_c_ctx,0,0x10000001,0x30000001,1025,80,m_vlan,false);
...
int CClientServerTcp::simple_http_generic(method_program_cb_t cb){
    ...
    c_flow = m_c_ctx.m_ft.alloc_flow(&m_c_ctx,0,0x10000001,0x30000001,1025,80,m_vlan,m_ipv6);
    CFlowKeyTuple   c_tuple;
    c_tuple.set_ip(0x10000001);
    c_tuple.set_port(1025);
    c_tuple.set_proto(6);
...
int CClientServerTcp::fill_from_file() {
    ...
    c_flow = m_c_ctx.m_ft.alloc_flow(&m_c_ctx,0,0x10000001,0x30000001,src_port,dst_port,m_vlan,false, tg_id);
