...
protected:
    ...
    bool check_all_profiles_state(const states_t &checklist);
...
private:
    /* Waiting list for mass start command execution. <profile_id, cmd> */
    std::map<std::string, std::string> m_cmd_wait_list;
};
