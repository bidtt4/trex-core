...
public:
    CClientInfo() :  CSimpleClientInfo<CIpInfo>(ipv4v6_addr::ipv4_le(0)) {
...
public:
    CClientInfoL() :  CSimpleClientInfo<CIpInfoL>(ipv4v6_addr::ipv4_le(0)) {
...
TEST(tuple_gen,clientPoolL) {
    ...
    gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x10000001),  ipv4v6_addr::ipv4_le(0x10000f01), 64000, g_dummy, 
               0,0);
    CTupleBase result;
    uint32_t result_src;
...
TEST(tuple_gen,clientPool) {
    CClientPool gen;
    gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x10000001),  ipv4v6_addr::ipv4_le(0x10000021), 64000000, g_dummy,
               0,0);
    CTupleBase result;
    uint32_t result_src;
    uint16_t result_port;
...
TEST(tuple_gen,serverPool) {
    CServerPool gen;
    gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x30000001),  ipv4v6_addr::ipv4_le(0x30000ff1), 6400000);
    CTupleBase result;
    ...
    gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x30000001),  ipv4v6_addr::ipv4_le(0x30000003), 64000000);
...
TEST(tuple_gen,servePoolSim) {
    ...
    gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x30000001),  ipv4v6_addr::ipv4_le(0x40000001), 640000);
    CTupleBase result;
    uint32_t result_dest;
...
TEST(tuple_gen,GenerateTuple2) {
    ...
    c_gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x10000001),  ipv4v6_addr::ipv4_le(0x1000000f), 64000*4, g_dummy,
               0,0);
    CServerPool s_gen;
    CServerPool s_gen_2;
    s_gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x30000001),  ipv4v6_addr::ipv4_le(0x30000ff1), 640000);
    CTupleBase result;
...
//    EXPECT_EQ((size_t)0, gen.m_clients.size());
    c_gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x10000001),  ipv4v6_addr::ipv4_le(0x1000000f), 64000*400, g_dummy, 
               0,0);
    s_gen.Create(cdSEQ_DIST, 
               ipv4v6_addr::ipv4_le(0x30000001),  ipv4v6_addr::ipv4_le(0x30000001), 640000);
    for(int i=0;i<200;i++) {
        s_gen.GenerateTuple(result);
        c_gen.GenerateTuple(result);
    //    gen.Dump(stdout);
...
TEST(tuple_gen,split1) {
    ...
    fi.m_ip_start = ipv4v6_addr::ipv4_le(0x10000000);
    fi.m_ip_end   = ipv4v6_addr::ipv4_le(0x100000ff);
...
TEST(tuple_gen,split2) {
    ...
    fi.m_ip_start =ipv4v6_addr::ipv4_le(0x20000000);
    fi.m_ip_end   =ipv4v6_addr::ipv4_le(0x200001ff);
...
TEST(tuple_gen,template1) {
    ...
    gen.Create(1, 1); 
    gen.add_client_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x10000001),ipv4v6_addr::ipv4_le(0x1000000f),64000, g_dummy, 0, 0);
    gen.add_server_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x30000001),ipv4v6_addr::ipv4_le(0x40000001),64000,false);
    CTupleTemplateGeneratorSmart template_1;
    template_1.Create(&gen,0,0);
    template_1.SetSingleServer(true,ipv4v6_addr::ipv4_le(0x12121212),0,0);
    CTupleBase result;
...
TEST(tuple_gen,no_free) {
    CTupleGeneratorSmart gen;
    gen.Create(1, 1);
    gen.add_client_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x10000001),ipv4v6_addr::ipv4_le(0x10000001),64000,g_dummy,0,0);
    gen.add_server_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x30000001),ipv4v6_addr::ipv4_le(0x400000ff),64000,false);
    CTupleTemplateGeneratorSmart template_1;
    template_1.Create(&gen,0,0);
...
TEST(tuple_gen_2,GenerateTuple) {
    CTupleGeneratorSmart gen;
    gen.Create(1, 1); 
    gen.add_client_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x10000001),ipv4v6_addr::ipv4_le(0x10000f01),64000,g_dummy,0,0);
    gen.add_server_pool(cdSEQ_DIST,ipv4v6_addr::ipv4_le(0x30000001),ipv4v6_addr::ipv4_le(0x40000001),64000,false);
    CTupleTemplateGeneratorSmart template_1;
    template_1.Create(&gen,0,0);
    CTupleBase result;
...
TEST(tuple_gen_yaml,yam_is_valid) {
    ...
    fi.m_client_pool[0].m_ip_start = ipv4v6_addr::ipv4_le(0x10000001);
    fi.m_client_pool[0].m_ip_end   = ipv4v6_addr::ipv4_le(0x100000ff);

    fi.m_server_pool[0].m_ip_start = ipv4v6_addr::ipv4_le(0x10000001);
    fi.m_server_pool[0].m_ip_end   = ipv4v6_addr::ipv4_le(0x100001ff);
    ...
    fi.m_server_pool[0].m_ip_end   = ipv4v6_addr::ipv4_le(0x10000007);
    ...
    fi.m_server_pool[0].m_ip_end   = ipv4v6_addr::ipv4_le(0x100003ff);
